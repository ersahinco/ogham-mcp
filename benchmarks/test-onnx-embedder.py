...
TEST_TEXTS = [
    ...
    "We decided to use PostgreSQL with pgvector for the memory backend because it supports both dense and sparse vector types natively.",
]
...
def main():
    ...
    for i, text in enumerate(TEST_TEXTS):
        ...
        print(f"  Sparse: {sparse_cmp['common']}/{sparse_cmp['total_keys']} common tokens "
        ...
        if n_colbert > 0:
            ...
            print(f"  ColBERT: {n_colbert} vectors, "
