...
MIG_033 = Path(__file__).parent.parent / "src/ogham/sql/migrations/033_topic_summaries_tldr.sql"
ROLLBACK_028 = (
    Path(__file__).parent.parent / "src/ogham/sql/migrations/DANGER_028_topic_summaries.sql"
)
ROLLBACK_033 = (
    Path(__file__).parent.parent / "src/ogham/sql/migrations/DANGER_033_topic_summaries_tldr.sql"
)
