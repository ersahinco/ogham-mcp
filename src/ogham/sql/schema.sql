...
-- (dim-agnostic, works at any EMBEDDING_DIM). The halfvec variant was
-- 2x smaller in memory but required a hardcoded dim in the cast; see
-- sql/migrations/021_dim_aware_halfvec.sql for the opt-in halfvec path.
